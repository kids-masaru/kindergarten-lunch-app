    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="bg-white p-4 shadow-sm sticky top-0 z-10 flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <button onClick={() => setIsReportModalOpen(true)} className="flex items-center gap-1 text-sm bg-blue-50 text-blue-600 px-3 py-2 rounded-lg font-bold hover:bg-blue-100">
            <span>クラス報告</span>
          </button>
